...
export default async function InfluenciadorTransparenciaPage() {
  ...
  const data = await getTransparenciaData(publicUser.id, 'influenciador')

  return (
    <PortalTransparencia profile="influenciador" data={data} />
  )
}
