...
export default async function IntermediarioTransparenciaPage() {
  ...
  const data = await getTransparenciaData(publicUser.id, 'intermediario')

  return (
    <PortalTransparencia profile="intermediario" data={data} />
  )
}
