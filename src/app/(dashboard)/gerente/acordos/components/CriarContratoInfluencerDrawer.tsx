...
export default function CriarContratoInfluencerDrawer({ influencer, acordo, onClose, onSuccess }: Props) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    setError(null)
    try {
      const res = await fetch('/api/gerente/contratos', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          id_contrato_pai: acordo.id,
          id_user_role_influencer: influencer.user_role_id,
