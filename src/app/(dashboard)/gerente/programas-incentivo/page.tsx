...
export default async function GerenteProgramasIncentivosPage() {
    ...
    <div className="animate-fade-in flex flex-col gap-6">
      <div>
        ...
        <p className="text-body-md text-[var(--color-on-surface-variant)] mt-1">
          Incentivos e bônus para sua rede
        </p>
      </div>
      <div className="glass-card rounded-xl py-20 flex flex-col items-center gap-3 text-[var(--color-on-surface-variant)]">
        ...
        <p className="text-xs opacity-40">Programas de incentivo para sua rede aparecerão aqui.</p>
      </div>
    </div>
  )
}
