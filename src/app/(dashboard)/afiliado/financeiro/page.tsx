...
export default async function AfiliadoFinanceiroPage() {
  ...
  try {
    ...
    console.error('[afiliado/financeiro] prisma error:', e)
  ...
  // FALHA = saque rejeitado, dinheiro não saiu → apenas informativo, não deduz saldo
