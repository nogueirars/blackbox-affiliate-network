...
export default async function AfiliadoProducaoPage({
  searchParams,
}: {
  ...
  try {
  if (myId) {
    // 1. Encontrar o user_role de AFILIADO para o usuário logado
    ...
    console.error('[afiliado/producao] prisma error:', e)
