...
export default async function AfiliadoTransparenciaPage() {
  ...
  const data = await getTransparenciaData(publicUser.id, 'afiliado')

  return (
    <PortalTransparencia profile="afiliado" data={data} />
  )
}
